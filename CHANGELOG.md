...
### Changed
- Migrated backend from Supabase to Appwrite for database and storage operations
- Updated all server actions to use Appwrite admin client for consistent permissions
- Replaced Supabase auth patterns with NextAuth + Appwrite database
